...
using MindPulse.Infrastructure.Shared.Services.Orchestrations;
...
builder.Services.AddScoped<IConfidenceRepository, ConfidenceRepository>();
...
builder.Services.AddScoped<ITestOrchestrationService, TestOrchestrationService>();
builder.Services.AddScoped<IQuestionService, QuestionService>();
builder.Services.AddScoped<IQuestionnaireService, QuestionnaireService>();
builder.Services.AddScoped<IUserResponseService, UserResponseService>();
builder.Services.AddScoped<ICategoryService, CategoryService>();
builder.Services.AddScoped<IConfidenceService, ConfidenceService>();
